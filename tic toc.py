...
class MyApp(Tk):
    def __init__(self):
        ...
        self.again_button = Button(self, text="again?", command=self.do_again,
                                   state=DISABLED,
                                   font=("Helvetica", 16))
        self.myLabel = Label(self, text="Who starts?",fg="red",bg="black",font=("Helvetica", 16))
        ...
        for i in range(1,10):
            self.bList[i] = Button(self, text="---",  #bList now button references
                                   ...
                                   width=7, font=("Helvetica", 24),bg="orange",fg="red")
    ...
    def test_done(self):
        ...
        if not (0 in self.bState):
            self.myLabel.config(text="Draw, game over!",fg="blue")
            self.gameDone = TRUE
        ...
        if 3 in self.mySums: #note 3 in mySums means player has won
            self.myLabel.config(text="You won!",fg="green")
            self.gameDone = TRUE
            self.again_button.config(state=NORMAL)
        elif -3 in self.mySums: #note -3 in mySums means computer has won
            self.myLabel.config(text="Computer won!",fg="red")
            self.gameDone = TRUE
            self.again_button.config(state=NORMAL)
    ...
    def do_again(self):
        ...
        self.myLabel.config(text="Who starts?",fg="red",bg="black")
